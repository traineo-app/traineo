...
- PRIORIZA SIEMPRE los ejercicios mejor valorados (★★★★★ / ★★★★☆) de las tablas de EXERCICIS CLAU del cervell del coach (split squat búlgaro, trap bar deadlift, RDL / hip hinge, soleus calf raise bent-knee, step-up, Pallof press, dead bug, plancha lateral, Copenhagen plank, etc.). EVITA los peor valorados (★★☆☆☆ o menos: crunch, russian twist, plancha abdominal como ejercicio principal, dips y press banca en perfiles endurance salvo natación/híbridos, foam roller sobre IT band). Respeta las notas de cada tabla (p. ej. lunges/walking lunge tienen coste excéntrico alto: alejarlos de sesiones clave de running).
